# A simple 2 layer MLP model only contains ReLU activation
...
class MLP2(Pruneable):
    def __init__(self,device="cuda",hidden_dim=64,output_dim=10,input_dim=(1,),**kwargs):
        super(MLP2,self).__init__(device=device,output_dim=output_dim,input_dim=input_dim,**kwargs)
