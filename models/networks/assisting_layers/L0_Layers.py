...
Sourced from authors github at:
https://github.com/AMLab-Amsterdam/L0_regularization
"""


class L0Linear(Module):
    """Implementation of L0 regularization for the input units of a fully connected layer"""
    
    def __init__(self, input_dim, output_dim, bias=True, weight_decay=5e-5, droprate_init=0.5, temperature=2. / 3.,
                 lamba=1.5, local_rep=False, **kwargs):
        """
        ...
        self.qz_loga = Parameter(torch.Tensor(input_dim))
...
class L0Conv2d(Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, padding=0, dilation=1, groups=1, bias=True,
                 droprate_init=0.5, temperature=2. / 3., weight_decay=1., lamba=3., local_rep=False, **kwargs):
        """
